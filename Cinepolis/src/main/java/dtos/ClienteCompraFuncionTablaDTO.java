 ...
 */
public class ClienteCompraFuncionTablaDTO {
    ...
    public ClienteCompraFuncionTablaDTO() {
        
    }

    public ClienteCompraFuncionTablaDTO(int idClienteCompraFuncion, Date fechaCompra, int asientosComprados, float costo, int idFuncionCompra, int idClienteCompra) {
    ...
    public String toString() {
        return "ClienteCompraFuncionTablaDTO{" + "idClienteCompraFuncion=" + idClienteCompraFuncion 
                + ", fechaCompra=" + fechaCompra 
                + ", asientosComprados=" + asientosComprados 
                + ", costo=" + costo 
                + ", idFuncionCompra=" + idFuncionCompra 
                + ", idClienteCompra=" + idClienteCompra + '}';
    }
